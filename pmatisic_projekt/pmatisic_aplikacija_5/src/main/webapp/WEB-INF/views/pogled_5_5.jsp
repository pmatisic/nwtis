...
<body>
    <div class="container">
        ...
        <ul class="list-group">
			...
			<li class="list-group-item"><a href="${pageContext.servletContext.contextPath}/mvc/aerodromi">Prijava</a></li>
			<li class="list-group-item"><a href="${pageContext.servletContext.contextPath}/mvc/aerodromi">Pregled</a></li>
        </ul>
        <br>
